          ...
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
            ...
            <div className="p-8">
              ...
              <div className="text-center mb-8">
                <div className="flex justify-center mb-4">
                  <div className="relative">
                    ...
                    {/* Home button on top of logo */}
                    <button
                      onClick={goBackToLanding}
                      className="absolute -top-2 -right-2 p-2 bg-white rounded-full shadow-md hover:shadow-lg transition-all duration-200 hover:bg-gray-50 border border-gray-100"
                      title="Go to Home"
                    >
                      <FiHome className="text-gray-600 hover:text-emerald-600 w-4 h-4" />
                    </button>
                  </div>
                </div>
              ...
              <div className="text-center space-y-4">
                <a href="/forgot-password" className="text-sm text-emerald-600 hover:text-emerald-700 font-medium transition-colors duration-200 block">
                  Forgot password?
                </a>
                ...
                <div className="pt-4 border-t border-gray-200">
                  <button
                    onClick={goBackToLanding}
                    className="flex items-center justify-center gap-2 text-gray-600 hover:text-emerald-600 transition-colors duration-200 mx-auto group"
                  >
